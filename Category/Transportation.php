...
<div class="row">
    ...
    <div class="col-lg-12 banner">
        <div class="container">
            ...
            <p>
                Here you can find any Transportation that you lost.
            </p>
        </div>
    </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="list">
                        <table class="table" id="container" style="background-color: #ffffff">
                            ...
                            <tbody>
                            <?php
                            $getAllTransportation = $mysqli->query("SELECT items.*, DATE_FORMAT(items.DatePosted,'%b %d %Y') AS DatePosted FROM items WHERE Category = '18' AND verified=0");

                            if ($getAllTransportation) {
                                if (mysqli_num_rows($getAllTransportation) > 0) {
                                    while ($rows = mysqli_fetch_array($getAllTransportation, MYSQL_ASSOC)) {
                    ...
                    <div class="tab-pane" id="grid" style="">
                        <div class="row">
                            <?php
                            $getAllTransportation = $mysqli->query("SELECT * FROM items WHERE Category = '18'");
                            if ($getAllTransportation) {
                                if (mysqli_num_rows($getAllTransportation) > 0) {
                                    while ($rows = mysqli_fetch_array($getAllTransportation, MYSQL_ASSOC)) {
