...
<div class="row">
    ...
    <div class="col-lg-12 banner">
        <div class="container">
            <h2>Jewelry</h2>
            <p>
                Here you can find any Jewelry that you lost.
            </p>
        </div>
    </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="list">
                        <table class="table" id="container" style="background-color: #ffffff">
                            ...
                            <tbody>
                            <?php
                            $getAllJewelry = $mysqli->query("SELECT items.*, DATE_FORMAT(items.DatePosted,'%b %d %Y') AS DatePosted FROM items WHERE Category = '8' AND verified=0");

                            if ($getAllJewelry) {
                                if (mysqli_num_rows($getAllJewelry) > 0) {
                                    while ($rows = mysqli_fetch_array($getAllJewelry, MYSQL_ASSOC)) {
                    ...
                    <div class="tab-pane" id="grid" style="">
                        <div class="row">
                            <?php
                            $getAllJewelry = $mysqli->query("SELECT * FROM items WHERE Category = '8' AND verified=0");
                            if ($getAllJewelry) {
                                if (mysqli_num_rows($getAllJewelry) > 0) {
                                    while ($rows = mysqli_fetch_array($getAllJewelry, MYSQL_ASSOC)) {
