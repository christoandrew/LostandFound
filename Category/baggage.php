...
<div class="row">
    ...
    <div class="col-lg-12 banner">
        <div class="container">
            <h2>Luggage</h2>
            <p>
                Here you can find any pets or Luggage that you lost.
            </p>
        </div>
    </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="list">
                        <table class="table" id="container" style="background-color: #ffffff">
                            ...
                            <tbody>
                            <?php
                            $getAllLuggage = $mysqli->query("SELECT items.*, DATE_FORMAT(items.DatePosted,'%b %d %Y') AS DatePosted FROM items WHERE Category = '2' AND verified=0");

                            if ($getAllLuggage) {
                                if (mysqli_num_rows($getAllLuggage) > 0) {
                                    while ($rows = mysqli_fetch_array($getAllLuggage, MYSQL_ASSOC)) {
                    ...
                    <div class="tab-pane" id="grid" style="">
                        <div class="row">
                            <?php
                            $getAllLuggage = $mysqli->query("SELECT * FROM items WHERE Category = '2' AND verified=0");
                            if ($getAllLuggage) {
                                if (mysqli_num_rows($getAllLuggage) > 0) {
                                    while ($rows = mysqli_fetch_array($getAllLuggage, MYSQL_ASSOC)) {
