...
<div class="row">
    ...
    <div class="col-lg-12 banner">
        <div class="container">
            <h2>Clothing</h2>
            <p>
                Here you can find any Clothing that you lost.
            </p>
        </div>
    </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="list">
                        <table class="table" id="container" style="background-color: #ffffff">
                            ...
                            <tbody>
                            <?php
                            $getAllClothing = $mysqli->query("SELECT items.*, DATE_FORMAT(items.DatePosted,'%b %d %Y') AS DatePosted FROM items WHERE Category = '3' AND verified=0");

                            if ($getAllClothing) {
                                if (mysqli_num_rows($getAllClothing) > 0) {
                                    while ($rows = mysqli_fetch_array($getAllClothing, MYSQL_ASSOC)) {
                    ...
                    <div class="tab-pane" id="grid" style="">
                        <div class="row">
                            <?php
                            $getAllClothing = $mysqli->query("SELECT * FROM items WHERE Category = '3' AND verified=0");
                            if ($getAllClothing) {
                                if (mysqli_num_rows($getAllClothing) > 0) {
                                    while ($rows = mysqli_fetch_array($getAllClothing, MYSQL_ASSOC)) {
